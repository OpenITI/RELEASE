...
//$("head").append('<script type="text/javascript" src="db/OpenITI_metadata_light-arabic.js"></script>');
        ...
        "columns": [
...

            {
                ...
                "render": function (data, type, row, meta) {
                    ...
                    bookFolderUrl = 'data/' + data.split(".")[0] + "/" + data
...

            {
                ...
                "render": function (data, type, row, meta) {
                    ...
                    authorUrl = 'data/' + row["book"].split(".")[0];
                    d = checknull(data);
